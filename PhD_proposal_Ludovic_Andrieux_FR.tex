...
\AfterPreamble{\hypersetup{
		...
		pdfsubject={Modélisation des ballottements d’ergols dans les réservoirs de véhicule spatiaux en conditions de micro-gravité ou sous faible facteur de charge.
		}
}}
