...
\begin{document}
	...
	\begin{itemize}
		\item Technique: Advances \acrshort{pinn}/\acrshort{pino} for nonlinear, multiphase \acrshortpl{edp} capturing on-board propellant physics (compressible gas–liquid interactions, free-surface dynamics, thermal transport and phase change, tank geometry and boundary conditions), with differentiability properties that can be used for \gls{mpc}.
	...
	State of the art: \acrshortpl{pinn} are at \acrshort{trl} 2–3 in fluid mechanics; proven for simpler \acrshortpl{pinn}, non-cryogenic two-phase flows, and non-aerospace domains.
	\\
